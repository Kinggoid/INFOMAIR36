...
def classify_by_majority_class(answer, dataset_utterance, dataset_dialog):
    
    majority_class = dataset_dialog.value_counts().idxmax()
...
def main():
    ...
    # Clean dataset
    Xc_train, Xc_test, yc_train, yc_test = clean_dataset()   

    # Run baseline algorithm untill 'quit':
    answer = "go"

    while answer != "quit":
        answer = input("Please tell me something: ")
        print(classify_by_majority_class(answer, Xc_train, yc_train))
